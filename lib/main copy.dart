...
//     if (accessToken != null) {  // Logged in
//       if (deepLink != null && deepLink.isNotEmpty) {
//         // Navigate directly to the deep link's target
//         navigatorKey.currentState?.pushNamed(deepLink); // Or pushReplacementNamed
//       } else {
//         navigatorKey.currentState?.pushNamed('/home'); // Default logged-in screen
//       }
//     } else {  // Not logged in
...
// //   runApp(const MyApp());
// // }
//   FirebaseMessaging.onBackgroundMessage(PushNotificationsService.onBackgroundMessage);
...
//   FirebaseMessaging.onMessage.listen((RemoteMessage message) async { // ***Combined Listener***
//     if (message.notification != null) {


//       showDialog( // Example AlertDialog. Replace with your notification display code!
